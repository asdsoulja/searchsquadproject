        ...
        getWordValues.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (getWord.getText().toString().trim().length() == 0) {
                    Toast.makeText(getActivity(), "You did not enter a word", Toast.LENGTH_LONG).show();
                }
                if (getWordType.getText().toString().trim().length() == 0) {
                    Toast.makeText(getActivity(), "You did not enter a word type", Toast.LENGTH_LONG).show();
                }
                if (getWordDefinition.getText().toString().trim().length() == 0) {
                    Toast.makeText(getActivity(), "You did not enter a word definition", Toast.LENGTH_LONG).show();
                }
